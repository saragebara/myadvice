...
public class BookingRequest {
    ...
    public BookingRequest(String requesterRole, String studentName, String studentId,
                          String purpose, String advisorName, LocalDate preferredDate, String preferredTime,
                          String details) {
    ...
    public BookingRequest(String requesterRole, String studentName, String studentId,
                          ...
                          String details) {
        this(requesterRole, studentName, studentId, purpose, null, preferredDate, preferredTime, details);
    }
